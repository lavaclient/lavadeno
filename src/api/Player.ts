...
import type { Manager, VoiceServer, VoiceState } from "../Manager.ts";
...
export class Player extends EventEmitter {
   ...
   * @since 2.1.x
   */
  public connect(channel: string | null | Dictionary<any>, options: ConnectOptions = {}): this {
   ...
   * @since 1.x.x
   */
  public play(track: string | Track, options: PlayOptions = {}): Promise<this> {
   ...
   * @since 2.1.x
   */
  public setEqualizer(bands: EqualizerBand[]): Promise<this> {
   ...
   * @private
   */
  private async _event(event: Event): Promise<void> {
    switch (event.type) {
      case "TrackEndEvent":
   ...
   * @private
   */
  private _playerUpdate(update: PlayerUpdate): void {
